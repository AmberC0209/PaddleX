...
def replace_links_in_file(file_path):
    ...
    # Define the regex pattern to match the links you want to replace
    pattern = r'\.\/docs\/([a-zA-Z0-9_\/]*)\.md'
    replacement_pattern = r'https://amberc0209.github.io/PaddleX/latest/\1.html'
