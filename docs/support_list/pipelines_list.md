...
<table>
    ...
    <tr>
        ...
        <td>商品图片的自动分类和识别、流水线上不合格产品的实时监控、安防监控中人员的识别</td>
    </tr>
    <tr>
        <td>通用目标检测</td>
        <td>目标检测</td>
        ...
        <td>视频监控中移动物体的跟踪、自动驾驶中车辆的检测、工业制造中缺陷产品的检测、零售业中货架商品的检测</td>
    </tr>
    <tr>
        <td>通用语义分割</td>
        <td>语义分割</td>
        ...
        <td>地理信息系统中卫星图像的分析、机器人视觉中障碍物、通行区域的物体的分割、电影制作中前景和背景的分离</td>
    </tr>
    <!-- 以下行请根据实际内容继续添加 -->
</table>
