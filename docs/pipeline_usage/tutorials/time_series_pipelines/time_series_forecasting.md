...
<b>注：以上精度指标测量自 [ETTH1](https://paddle-model-ecology.bj.bcebos.com/paddlex/data/Etth1.tar)。以上所有模型 GPU 推理耗时基于 NVIDIA Tesla T4 机器，精度类型为 FP32， CPU 推理速度基于 Intel(R) Xeon(R) Gold 5117 CPU @ 2.00GHz，线程数为8，精度类型为 FP32。</b>
